...
local win = ULlib:Window("冷脚本 | piggy",Color3.fromRGB(204, 0, 0), Enum.KeyCode.RightControl)
...
tab2:Toggle("绘制玩家 1", false, function(state)
print("加载完成")
...
tab2:Toggle("绘制玩家 2", false, function(state)
...
tab2:Toggle("绘制小猪[是机器人不是玩家!]", false, function(state)
local Players = game:GetService("Players")
...
tab2:Toggle("绘制物品", false, function(state)
